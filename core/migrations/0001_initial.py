    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='core.livraisonalbum')),
            ],
        ),
        migrations.CreateModel(
            name='Photo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(choices=[('mariage', 'Mariage'), ('corporate', 'Corporate'), ('evenement', 'Événement'), ('famille', 'Famille'), ('video', 'Vidéo'), ('culinaire', 'Culinaire'), ('autres', 'Autres')], max_length=50)),
